...
class MainApp:
        ...
        page.views.append(
            ft.View(
                ...
                controls=[
                    ...
                    ft.ElevatedButton("Show Database", on_click=lambda e: self.show_database(page)),
    ...
    def show_database(self, page):
        client = MongoClient("mongodb://localhost:27017/")
        db = client["anti_rabies_db"]
        users_collection = db["users"]
        pets_collection = db["pets"]
        rabies_collection = db["rabies_cases"]

        doc1 = users_collection.find_one()
        doc2 = pets_collection.find_one()
        doc3 = rabies_collection.find_one()
